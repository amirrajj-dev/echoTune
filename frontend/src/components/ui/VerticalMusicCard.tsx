...
const VerticalMusicCard = ({ song, isPlaying, onPlayPause }: Props) => {
  return (
    <motion.div
      layout
      ...
      className="relative flex flex-col p-4 rounded-2xl bg-base-300 hover:shadow-2xl transition-all w-full h-full group border border-white/5"
    >
      <div className="relative w-full aspect-square rounded-xl overflow-hidden shadow-sm mb-3">
        <img
          src={song.imageUrl}
          alt={song.title}
